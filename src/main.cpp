...
unsigned int nStakeMinAge = 8 * 60 * 60; // BarberCash - 8 hours
...
const string strMessageMagic = "BarberCash Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
        nSubsidy = 302400 * COIN;
    }
        else if(pindexBest->nHeight+1 >= 2  && pindexBest->nHeight+1 <= 40320)
    {
        nSubsidy = 48 * COIN;
    }
        else if(pindexBest->nHeight+1 >= 40321)
    {
        nSubsidy = 12 * COIN;
    }  
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    // proof of stake rewards. POS begins at block 2000
    
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);  //default 17% yr

        if(pindexBest->nHeight+1 >= 2000 && pindexBest->nHeight+1 <= 10080)
    {
        nSubsidy = 60 * COIN;
    }
    ...
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);  //default 17% yr
    }       
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // BarberCash: check proof-of-stake block signature
...
// BarberCash: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BarberCash", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    string strPubKey = "11a173ee507ee72c3dc5a208621a0e3b80cdaff20d9fa23a050196c1579b386d";
